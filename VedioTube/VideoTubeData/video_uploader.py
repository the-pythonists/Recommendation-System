...
url = "http://127.0.0.1:8000/uploadsave/"
driver.get(url)
...
tmdb.API_KEY = '1efc8b0c02ac0eaa89ce2e2db079ab02'
...
r = requests.get('https://api.themoviedb.org/3/genre/movie/list?api_key=1efc8b0c02ac0eaa89ce2e2db079ab02&language=en-US')
...
for movie in os.listdir('D:\\VedioTube\\VideoTubeData\\'):
	movie_category = ''
	if movie.endswith('.mp4'):
		...
		video.send_keys('D:\\VedioTube\\VideoTubeData\\'+movie)
		thumb.send_keys('D:\\VedioTube\\VideoTubeData\\'+str(movie.split('.')[0])+'.jpg')
